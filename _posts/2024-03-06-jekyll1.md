...
math: true
# pin: true
media_subpath : /assets/img/post/其他
...
> 本文完全搬运于 https://huanyushi.github.io/posts/chirpy-blog-customization/ ，感谢大佬高质量的文章
{: .prompt-warning }
...
![theme file](theme-file.webp){: .shadow width="700"}
_封装的样式文件地址_
...
<table>
<tr>
  <td><img src="friend1.webp" alt="friend example1"></td>
  <td><img src="friend2.webp" alt="friend example2"></td>
  <td><img src="friend3.webp" alt="friend example3"></td>
</tr>
</table>
...
![github-contrib](github-contrib.webp)
_GitHub 贡献图_
...
```
![inverse comparison](inverse.webp){:.light}
![inverse comparison](inverse-dark.webp){:.dark}
_反色图片与原图片对比_
